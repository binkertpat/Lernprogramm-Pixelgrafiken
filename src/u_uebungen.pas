...
begin
 uebungsaufgabestellen(strtoint(startseiteundnavstruktur.uebungsnummer)+1); //einbindung der prozedur aus anderer unit
...
var antwort:string;
begin
 case strtoint(startseiteundnavstruktur.uebungsnummer) of   //loesungen der aufgaben
   1: antwort:='16:9';
   2: antwort:='2,0736';
   3: antwort:='22,89';
   4: antwort:='5:4';
 ...
 if E_loesung.text=antwort then //ueberpruefung der antworten
  begin
