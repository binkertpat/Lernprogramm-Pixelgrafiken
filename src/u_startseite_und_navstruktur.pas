...
procedure uebungsaufgabestellen(n:integer);  //ermoeglicht zugriff aus anderer unit
...
var i:integer;
begin
if (E_vorname.text='') OR (E_nachname.text='') OR (E_klassenstufe.text='') then  //fehlermeldung wenn nicht alle daten eingegeben wurden
 begin
  B_starten.left:=520;
  T_alledaten.show;
 end
